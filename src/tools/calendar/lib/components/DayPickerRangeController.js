...
// var _moment2 = _interopRequireDefault(_momentJalaali);
...
var _toISODateStringJalali = require('../utils/toISODateStringJalali');

var _toISODateStringJalali2 = _interopRequireDefault(_toISODateStringJalali);

var _toISOMonthStringJalali = require('../utils/toISOMonthStringJalali');

var _toISOMonthStringJalali2 = _interopRequireDefault(_toISOMonthStringJalali);
  ...
  _createClass(DayPickerRangeController, [{
    ...
    value: function () {
      function onPrevMonthClick() {
        ...
        var prevMonth = currentMonth.clone().subtract(2, 'jMonths');
        var prevMonthVisibleDays = (0, _getVisibleDays2['default'])(prevMonth, 1, enableOutsideDays, true);

        var newCurrentMonth = currentMonth.clone().subtract(1, 'jMonth');
        this.setState({
    ...
    value: function () {
      function addModifier(updatedDays, day, modifier) {
        ...
        if (orientation !== _constants.VERTICAL_SCROLLABLE) {
          ...
          // currentMonth = _momentJalaali(currentMonth).clone().subtract(1, 'jMonth');
        ...
        if (enableOutsideDays){
          var monthsToUpdate = Object.keys(visibleDays).filter(function (monthKey) {
           ...
           //console.log(Object.keys(visibleDays[_momentJalali(monthKey)]).indexOf(isoJ));
           // return Object.keys(visibleDays[_momentJalali(monthKey)]).indexOf(isoJ) > -1;
          });
          ...
          // console.log(updatedDays[monthIso]);
          // console.log(visibleDays[monthIso]);
          //var nextMonthIso = (0, _toISOMonthString2['default'])(_momentJalali(day).add(1,'jMonth'));
    ...
    value: function () {
      function isEndDate(day) {
        // console.log(day);
        // console.log(_momentJalaali(day));
    ...
    value: function () {
      function isInSelectedSpan(day) {
        ...
        // return _momentJalaali(day).isBetween(_momentJalaali(startDate), _momentJalaali(endDate));
