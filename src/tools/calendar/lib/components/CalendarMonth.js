  ...
  _createClass(CalendarMonth, [{
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        ...
        if (!_momentJalaali(month).isSame(this.props.month)|| enableOutsideDays !== this.props.enableOutsideDays || firstDayOfWeek !== this.props.firstDayOfWeek) {
          this.setState({
                ...
                return _react2['default'].createElement(
                  ...
                  week.map(function (day, dayOfWeek) {
                    return renderCalendarDay({
                      ...
                      day: day,
                      daySize: daySize,
                      isOutsideDay: !day || _momentJalaali(day).jMonth() !== _momentJalaali(month).jMonth(),
