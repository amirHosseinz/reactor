                     ...
                     <div className={isSticky?"bookmark-share-container-sticky":"bookmark-share-container-not-sticky"}>
                       ...
                       <div className="share-section">
                         <div className="share-icon-container-telegram">
                           <a className="share-link" target="_blank" href={"https://telegram.me/share/url?url=http://www.tripinn.ir/"+window.location.href.split("/")[window.location.href.split("/").length-2]+"/"+this.state.homeData.id  +"&text="+this.state.homeData.title}>
                         ...
                         <div className="share-icon-container-google-plus">
                           <a className="share-link" target="_blank" href={"https://plus.google.com/share?url=http://www.tripinn.ir/"+ window.location.href.split("/")[window.location.href.split("/").length-2] +"/" + this.state.homeData.id}>
                         ...
                         <div className="share-icon-container-twitter">
                           <a className="share-link" target="_blank" href={"https://twitter.com/intent/tweet?url=http://www.tripinn.ir/"+window.location.href.split("/")[window.location.href.split("/").length-2] +"/" + this.state.homeData.id}>
