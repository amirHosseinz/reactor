...
import './AboutUs.css';
class AboutUsMD extends React.Component{
  constructor(props){
    super(props);
    this.state={
    };
  ...
  render(){
    return (
      <div className='about-us-container-md'>
        ...
        <p className="dabout-us-descriptions"> اگر برای سفر به دنبال اقامتگاهی مناسب هستید تریپین برای شما بهترین انتخاب است.
      <br/>
