...
class TermsXs extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      OpenPanel1:false,
  ...
  render(){
    return(
      <div className='terms-cadre-xs'>
        <div className="terms-container-xs" dir="rtl">
          <h1 className='terms-header-xs'>قوانین و مقررات  <span className='terms-tripinn-brand-heading'>تریپین</span></h1>
          <div>
          ...
          <p className='terms-sub-title-xs'>
         ...
         <span>۲) </span><span>  استفاده از خدمات</span>
          ...
          <Collapsible onClose={this.renderClosePanel1.bind(this)} onOpen={this.renderOpenPanel1.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel1?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۱-</span> <span> مقررات ثبت نام و تأیید حساب کاربری</span></span> <img className={this.state.OpenPanel1?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          ...
          <Collapsible onClose={this.renderClosePanel2.bind(this)} onOpen={this.renderOpenPanel2.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel2?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span> ۲-۲- </span> <span>   مقررات ثبت اقامتگاه</span></span> <img className={this.state.OpenPanel2?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel3.bind(this)} onOpen={this.renderOpenPanel3.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel3?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۳-</span><span> مقررات رزرو </span></span> <img className={this.state.OpenPanel3?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel4.bind(this)} onOpen={this.renderOpenPanel4.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel4?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۴-</span><span> مقررات تحویل خانه </span></span> <img className={this.state.OpenPanel4?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel5.bind(this)} onOpen={this.renderOpenPanel5.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel5?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۵-</span><span>مقررات نقد و امتیازدهی</span></span> <img className={this.state.OpenPanel5?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel6.bind(this)} onOpen={this.renderOpenPanel6.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel6?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}>  <span>۲-۶-</span><span> مقررات مالی مهمان </span></span> <img className={this.state.OpenPanel6?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel7.bind(this)} onOpen={this.renderOpenPanel7.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel7?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span> ۲-۷- </span> <span>مقررات مالی میزبان  </span></span> <img className={this.state.OpenPanel7?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          ...
          <Collapsible onClose={this.renderClosePanel8.bind(this)} onOpen={this.renderOpenPanel8.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel8?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۸-</span><span> مقررات کنسل کردن رزرو و بازپرداخت </span></span> <img className={this.state.OpenPanel8?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          <p className="terms-descriptions">
          ...
          <Collapsible onClose={this.renderClosePanel9.bind(this)} onOpen={this.renderOpenPanel9.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel9?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}><span>۲-۹-</span><span> مقررات مربوط به اعمال غیرقانونی </span></span> <img className={this.state.OpenPanel9?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
          <p className="terms-descriptions">
          ...
          <p className="terms-descriptions">
          ه)	در صورت حذف حساب کاربری توسط هر یک از طرفین، سیاست‌های لغو رزرو مبنی بر بند ۸-۲ اجرا خواهد شد و طرفین ملزم به تمکین خواهند بود.
          </p>
          <p className="terms-descriptions">
          ...
          <Collapsible onClose={this.renderClosePanel11.bind(this)} onOpen={this.renderOpenPanel11.bind(this)} trigger={<div className="terms-panel-box"><span className={this.state.OpenPanel11?"terms-close-panel1-text-xs":"terms-close-panel1-text-xs"}>۲-۱۱- حریم خصوصی و محتویات</span> <img className={this.state.OpenPanel11?"terms-open-panel-img":"terms-close-panel-img"} src={require('../Images/angle-down copy.svg')} width="30" height="30" /></div>}>
          <div className='terms-panel1-container'>
